...
% To remove it, comment it out or delete it.
  ...
  * The introductory information in this thesis is generalized. There are almost
...
the brain, notabley within the hypothalamus and pituitary where they play a negative
feedback role for the HPA axis. Additionally, GRs are found in prominant
forebrain structures, such as the hippocampus and prefrontal cortex. The G-coupled protein receptors, when activated,
...
Chronic stress is associated with an extensive amount of psychological and
immune diseases.
\subsection{Epigenetic Changes from Stress}
\subsection{Pro-inflammatory Stress Response}
\subsection{Early Life Stress}
	
\section{Long Term Effects of Early Life Experience}

\subsection{Maternal Care and Stress}
The lab of Michael Meaney has done years of groundbreaking work on how maternal
care alters the stress response in rats. In 1997, his lab published a paper describing
the reprogramming of the HPA-axis as a product of licking and grooming (LG).
Pups reared by high LG dams displayed reduced corticosterone responses to acute
stress, increased hippocampal GR mRNA, and decreased hypothalamic CRH mRNA
(Meaney, gluc). In a follow-up cross-fostering study, Meaney showed that the
HPA-axis reprogramming was dependent on the foster mother's, and importantly not
the biological mother's. Additionally, the quality of LG was transgenerational
through fostering lineage, \textit{i.e.}, the LG patterns of the foster mother
predicted that of the female pups. (transgenerational). In 2004, Meaney
published a paper on the epigenetics of the above discoveries. He found that  
