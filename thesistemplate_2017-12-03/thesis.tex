...
% So are Acknowledgments (proper English spelling)
  ...
  writing a thesis. Any success I have had has been largely based in my access to extracurriculars, good parents, and supportive friends. I would like to thank:
  ...
  the year. Also to the rest of the Renn lab for helping me learn the ways of fish research.
...
% To remove it, comment it out or delete it.
  ...
  that science also has the ability to liberate individuals. I hope that at the
  least this
  thesis makes one think of how plastic we are to our day-to-day experiences.
...
the enviornment. Traditionally, these two possibilities have been thought of as
...
revisited in Chapter 1), refers to
...
genome is utilized. This research is crucial because it implies that, as animals, our behavior
can be drastically altered by our environment. We must strive to understand how
the spaces we create impact one another and to interrogate the ways in which we
judge people's ability to control their actions. 
...
explaining the physiological components of the stress response and how this can
be changed by the environment. Then
...
homeostatis (Bodegom). An important aspect of the stress response is the production and mobilization
 ...
 source of energy. The following section
...
\caption[Signaling cascade of the HPA axis]{\footnotesize{Signaling cascade of the HPA axis.\\ As a response to
  ...
  arenal cortices of the adrenal glands, leading to the production of steroid
...
brain areas. In the presense of an immediate stressor, brain regions associated with
...
structures involved in learning and fear such as the hippocampus and amygdala.
...
cellular function of the GR subtypes(Lu, Collins, Grissom, \& Cidlowski, 2007). A genome duplication event happened in the evolution of teleosts, causing them
...
\caption[Glucocorticoid receptor mechanism of action]{\footnotesize{Glucocorticoid receptor
    ...
    cell membrane and bind to glucocorticoid receptors. Glucorticoid receptors
    then undergoe a confirmational change, shedding the protein complex, and
...
tissue repair or immune response required (Herman et al). Because
...
pituitary ACTH release (Keller-Wood, 2015). In addition to regulation within the
...
excess circulating glucorticoids are also potentially maladaptive, leading to developmental
reprogramming (Tsai book). The offspring of pregnant mice treated with synthetic glucocorticoids
 ...
 increase CPP in response to benzodiazepines (Lakehayli, 2015), cocaine
...
environment can also be influential to an organism's development. The lab of Michael Meaney has done years of groundbreaking work on how maternal
...
(Taborsky 2012).  This was comlimented by a similar study by Taborsky in \textit{A. burtoni}. Fry raised
...
males, both dominant and subordinant females are reproductively active. Females take part in a brood care strategy known as mouthbrooding. The female lays eggs and immediately picks them up, storing them in
her buccal cavity. Shortly after this, the males fertilizes the eggs. The
...
predators and conspecifics, potentially reducing their exposure to stressful expreiences.
...
are different. The second change is that this thesis will examine
...
\caption[Experimental conditions]{\footnotesize{Experimental conditions.\\
    Mouthbrooding fish were selected to be in either of two experiemntal groups.
  In the first condition (top) mothers were transfered to individual tanks
...
fry were old enough to regularly leave their mother's mouth (~ 2 weeks post-fertilization), at which point the mother was removed from the tank to prevent her from eating the fry. 
...
the eggs developed into freely moving fry (~ 2 weeks post-fertilization), the flask was removed from the tank and a piece of terra cotta was added.

\subsection{Behavioral Tests}
Behavioral testing began approximately 130 days after the brooding mothers were
placed into experimental conditions. Both assays were performed on the same day.
...
The amount of chases, charges, and bites between fish were recorded for 10 minutes.}}
\label{subd}
\end{centering} 
\end{figure}
...
Because \textit{A. burtoni} are highly social fish, it is relevent to assess how
...
were recorded. The total sum of aggressive behaviors were then divided by the number of fish in the brood to create a score. Broods that only had one fish in them were excluded from this paradigm.  
...
\caption[Primer design]{\footnotesize{Primer design. \\ Primers sequences were taken
  from a study by . The location of the primers were then found by
  comparing the sequences to \textit{A. burtoni} transcriptional sequences using
the NCBI BLAST database. The forward primer of GR1a spans the }} 
\label{subd}
\end{centering} 
\end{figure}
...
\subsection{Glucocorticoid Receptor Expression}
