...
corticosteroids that are able to bind to glucocorticoids.  When
...
testing area. They were allowed to adjust to the change in lighting for 10 minutes. 
...
\hline
rfl23 & TGC TGA TGC CCA ACA TCG GTT & TCT TGG AGG AGA CAT TGT GGG\\
\hline
\end{tabular}
\end{center}
\end{table}
