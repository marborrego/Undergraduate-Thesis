...
GR1 mRNA expression in the telencephalon \citep{nyman_effect_2017}. Antagonizing GRs in fry reared without adults and helpers resulted in more appropriate
...
\textit{A. burtoni} are well suited for modeling the effects that
...
mouthbrooding behavior \citep{greenwood_multiple_2003, pijanowski_activity_2015, renn_fish_2008}.

In rats, it is known that high
maternal care leads to a decrease in anxiety-like behavior and an increase
in neuronal GR expression \citep{caldji_maternal_1998}. Stressed mothers exhibit
less maternal care, thus licking and grooming levels are an indicator of the
level of stressors in the adult environment \citep{}. By increasing the amount of GRs
in areas of the brain that inhibit HPA-axis activation, the pups stress response
is more tightly regulated, preventing unnecessary expendature of energy
\citep{}. \textbf{actual inhibitory aspects of HPA axis}. The converse is true of pups from low maternal mothers, where it is
adaptive for the pups to have a heightened response to their stressful
environment \citep{}.
...
aggression. \textbf{Expand on social system}. Based on these two bodies of literature, I predicted
...
burtoni} does not have a strong effect on the fry's stress response. Fry
...
While the experimental conditions did not differ in size, fish from broods of
one had a signicantly greater body ration and length compared to frish from
broods of two or three. 
...
GR2 expression and GR1b expression. There was also a negativee correlation
...
\citep{lupien_effects_2009, yamamoto_studies_2009}. \textbf{make a larger deal
  of this. Talk about homologies} 

It is possible that social conditions are much more important compared to
maternal separation in reprogramming the HPA axis of \textit{A. burtoni}. A
recent study found that \textit{A. burtoni} fry raised in pairs had decreased whole-brain GR1a
expression compared to fry raised in groups
\citep{solomon-lane_early-life_2018}. This indicates that the stress response of
fry are plastic to early-life experience. In adults, dominant males have an
increase in GR1a and GR2 receptor expression compared to non-dominant males \citep{korzan_social_2014}.
This is supported by the above finding that fry length is negatively correlated
with GR2 expression. While fry length is not a direct measure of dominance,
relative size of a male in a social group is a primary predictor of dominance
\citep{hofmann_social_1999}. Given that \textit{A. burtoni} are highly social
fish in which social status determines reproductive fitness and access to food,
plasticity as it relates to hierarchical ranking is adaptive \citep{fox_stress_1997}. 

\textbf{Difference between pulcher, burtoni, and rats}

Using \textit{A. burtoni} as a model organism for studying early life
stress offers a high throughput way to examine a complex condition. The question of how maternal separation in \textit{A.
...
mechanisms behind HPA axis reprogramming. \textbf{Change conclusion}
