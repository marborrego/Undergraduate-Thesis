...
\caption[Primer design]{\footnotesize{Primer design. \\ Primers sequences were taken
  from a study by . The locations of the primers were then found by
...
\begin{figure}[htbp] 
\begin{center} 
\includegraphics{size_unedited}
\caption[Comparison of fry size between groups.]{\footnotesize{The size of fish}}
\label{subd}
\end{center} 
\end{figure}

\textbf{Get data for actual weight and length}
Prior to euthanasia each fry's weight and length, from the nose to the beginning of
the caudal fin, were measured. 
Size was calculated to be the weight divided by body length. The conditions were
compared using a student's t-test for independent means. The two groups did not differ in their size (\underline{M} S = 0.20
g/cm, \underline{M} M = 0.23 g/cm, \underline{p} = 0.49). 

\subsection{Boldness}

\begin{figure}[htbp] 
\begin{center} 
\includegraphics{bottom_unedited}
\caption[Time spent at bottom of tank.]{\footnotesize{Bottom}}
\label{subd}
\end{center} 
\end{figure}
...
\begin{figure}[htbp] 
\begin{center} 
\includegraphics{top_unedited}
\caption[Time spent at top of tank.]{\footnotesize{Top}}
\label{subd}
\end{center} 
\end{figure}
...
\begin{figure}[htbp] 
\begin{center} 
\includegraphics{shelter_unedited}
\caption[Time spent behind the shelter.]{\footnotesize{Shelter}}
\label{subd}
\end{center} 
\end{figure}
...
\caption[Results of aggression assay.]{\footnotesize{Aggression. Yada yada}}
\label{subd}
\end{center} 
\end{figure}

To analyze the aggression, a Wilcox Ranked Sum test was used. There was no
significant difference between the two groups (\underline{M} S = 
g/cm, \underline{M} M =  g/cm, \underline{p} = 0.92).
