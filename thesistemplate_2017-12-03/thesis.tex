...
aggression.  Based on these two bodies of literature, I predicted
...
\textbf{More detail about each finding and their relationship to HPA-axis regulation}

\textbf{A paragraph about boldness/anxiety-like behavior. Mentioning previous studies}
...
\textbf{summary of finding up top}
...
\textbf{Go into detail about Taborky's analysis/N pulcher and why it might be different in
burtoni}
...
\textbf{Talk about distinction between entries and time spent in regions}
...
\textbf{Studies about GR expression correlation?}
...
\textbf{Be more specific about why you think there will be a difference. Try to
  find predator cue study}
