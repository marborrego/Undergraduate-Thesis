...
\textit{SD}=0.66;
\textit{M} unseparated=2.49 cm, \textit{SD}=0.44), \textit{t}(16)=0.67
,
\textit{p}=0.51; nor the weight
alone (\textit{M} separated=0.52 g, \textit{SD}=0.38; \textit{M} unseparated=
0.60 g, \textit{SD}=0.35) \textit{t}(16)=0.46, \textit{p}=0.65.
...
Broods in which there were only one fish (\textit{M} = 0.39 g/cm, \textit{SD} = 0.07) were significantly greater in
body ratio compared to broods with two (\textit{M} = 0.21 g/cm, \textit{SD} = 0.12) or three
(\textit{M} = 0.19 g/cm, \textit{SD} = 0.07)
fry, \textit{F}(2, 15) = 5.34, \textit{p} < 0.05. Additionally, broods with
only one fry (\textit{M} = 3.30 cm, \textit{SD} = 0.14) were longer than broods
with three fry (\textit{M} = 2.23 cm, \textit{SD} = 0.39),
\textit{F}(2, 15) = 4.70, (\textit{p} < 0.05); but not with two fry
(\textit{M} = 2.48 cm, \textit{SD} = 0.72). Further, fry from single broods
(\textit{M} = 1.29 g, \textit{SD} = 0.29) weighed more than fry from broods of two
(\textit{M} = 0.58 g, \textit{SD} = 0.37) or three (\textit{M} = 0.44 g, \textit{SD} = 0.21) fry,
\textit{F}(2, 15) = 9.49,
\textit{p} < 0.01. 
...
(\textit{Mdn} = 41.83\%) compared to those unseparated from their mothers (\textit{Mdn}
= 4.50\%), \textit{z} = -2.03, \textit{p} < 0.05. There was no significant difference between conditions in the
time spent at the top (\textit{Mdn} separated = 7.68\%, \textit{Mdn} unseparated
= 0.00\%
; \textit{z} = -1.23, \textit{p} = 0.22) and behind the shelter (\textit{Mdn} separated = 49.17\%,
...
(\textit{Mdn} = 3.66) and unseparated (\textit{Mdn} = 2.66) groups, \textit{z}
= 0.11, \textit{p} = 0.92.
