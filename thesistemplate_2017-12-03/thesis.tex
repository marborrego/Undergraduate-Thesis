...
% So are Acknowledgments (proper English spelling)
	...
	\epigraph{Any situation in which some individuals prevent others from engaging in the process of inquiry is one of violence.}{Paulo Freire \\ \textit{Pedagogy of the Oppressed}}
...
$\circ$ Suzy for pushing me to take the thesis process into my own hands and not
  giving up on me. Also the rest of the Renn lab, especially Leto, for helping me learn the ways of fish research.
...
$\circ$ Larry for supporting me in my research and giving me so much encouragement and
 ...
 $\circ$ Pixie for being a positive orb with very real concerns. I have the utmost respect for the way you move through the world.
	
$\circ$ James for inspiring me to study neuroscience and for giving me endless love
  and support.

$\circ$ Sonya for embodying the puke \& rally spirit while working all day in the library.
...
judge people's abilities to control their actions. I hope that at the
  least this thesis makes one think of how plastic we are to our day-to-day experiences.
    ...
    \textbf{PVN} & Paraventricular nucleus \\
...
% If your abstract is longer than a page, there may be a formatting issue.
  ...
  important adaptation. That being said, these adjustments can be harmful when
  the adult environment does not match the early environment. In humans, exposure to
  early-life stress is known to be correlated with a number of developmental
  disorders and neuropathologies. Early life stress is able to
  reprogram the hypothalamic-pituitary-adrenal axis of organisms, leading to a long-term alteration in the body's stress response. In mammals, poor maternal care is associated
  with an increase in circulating corticosteroids and anxiety-like behavior in
  stressful situations that persists throughout adulthood. This change in
  responsiveness to stressful situations is also accompanied by a decrease in inhibitory feedback of the
  hypothalamic-pituitary-adrenal axis, as measured by decreased glucocorticoid
  receptors. The present experiment aimed to model these studies done in mammals in the
  ...
  in boldness. There was no significant difference between experimental groups in
  body index, aggression, or glucocorticoid receptor expression; however, there
  were positive correlations between the expression of glucocorticoid receptor
  subtypes GR1a and GR2 as well as between
  GR1b and GR2. Additionally, the standard lengths of the
  fry were negatively correlated with their GR2 expression levels. These findings
  suggest that there are other factors, besides maternal separation, driving
  differences in glucocorticoid receptor expression.
...
reaction of responses, changing how an organism exists in its
...
Darwin's theory of evolution and Mendel's inheritance experiments were in
...
central dogma of genetics in 1958 \citep{crick_protein_1958}. This crucial concept states that DNA is transcribed into RNA, which is then
translated into amino acids that are linked together to form proteins (Figure \ref{dogma}).

\begin{figure}
\begin{center} 
\includegraphics[scale = 0.75]{dogma}
\caption[The central dogma of molecular biology including reverse transcription]{\footnotesize{The
  ...
  mRNA into a double stranded nucleic acid known as cDNA. Unlike DNA, cDNA
...
homeostatis \citep{van_bodegom_modulation_2017}. An important aspect of the stress response is the production and mobilization
 ...
 axis, which functions to produce glucocorticoids (Figure \ref{hpa}). As the name suggests,
...
\caption[Signaling cascade of the HPA axis]{\footnotesize{Signaling cascade of the HPA axis.\\ As a response to
  ...
  HPA axis signaling cascade. The paraventricular nucleus (PVN) of the
...
pallium in teleost) \citep{salas_neuropsychology_2006}.
...
increases the synthesis of cholesterol. Cholesterol, a precursor to steroid hormones, is then transported to the
outer mitochondrial matrix where the steroidogenic pathway begins. A major end
product of this pathway and thus of the HPA axis is glucocorticoids.
...
complex. When a GR is bound to by a glucocorticoid it goes through a
...
found in the promoter region of their target genes, though sometimes they are
...
\citep{2017Nrid, herman_limbic_2005} (Figure \ref{gluc}). The change in gene
transcription by GRs can in turn change appetitive behavior,
immune response, development, learning and memory, and other major behaviors \citep{2017Nrid}. 

Interestingly, GRs can also localize to the mitochondria,
...
inhibit HPA axis activity via GABAergic interneurons \citep{van_bodegom_modulation_2017}. 
...
no longer responding to them as stressors.
...
\caption[The match/mismatch hypothesis]{\footnotesize{The match/mismatch
    ...
    and maladaptive when the adult environment is mismatched. Rats
...
harmful in the low-stress environment (Figure \ref{match}). Further, the
adaptive value that comes with adjusting to a matching, stressful adult environment does not
negate the vast number of negative developmental consequences that result from glucocorticoid exposure.   
...
reprogramming \citep{2017Nrid}. The offspring of pregnant mice treated with synthetic glucocorticoids
 ...
 animals are conditioned to associate a drug with a given environment, at which
 point 
 their preference for that environment in the absence of the drug over a neutral
...
not the biological, mother.  GR receptor gene DNA methylation was decreased and
histone acetylation increased in HLG rats, consistent with earlier studies.

The work of Meaney's lab demonstrates that rats reared by LLG dams have a
...
behavior.  Mothers in stressful environments decrease
the amount of licking and grooming of their pups, suggesting that maternal care
is indicative of the environment \citep{zhang_epigenetics_2010}.
These findings support the match/mismatch hypothesis whereby
stressful offspring conditions, like low maternal care, heighten the HPA-axis
...
The work of Meaney has been incredibly influential in our understanding of how
parental care can shape the neuroendocrinology of offspring; though, there still exist many
open questions about maternal care's impact on offspring. Some examples of
needed research include
characterizing the genes and protein products involved in HPA axis regulation,
analyzing the epigenetic states of involved genes, and mapping out the neural
circuitry as it relates to plasticity to early life experience \citep{bolton_programming_2019, lesuis_early_2019,
...
between rodents and humans, murine experiments are relatively costly and slow
compared to other model organisms \citep{sengupta_laboratory_2013}. In
...
\citep{perlman_mouse_2016}. For these reasons, the
use of fish models in biomedical research has been growing in popularity
...
African cichlids, come from relatively recently caught wild stock, allowing for
...
While there doesn't exist much research on fish models of maternal separation,
Barbara Taborsky has examined how early social environment influences the fish
stress response.
...
expression and CRH compared to those raised in the absence of adults or helpers
...
GR1 mRNA expression in the telencephalon \citep{nyman_evolutionary_2018}.
...
early life social environment can influence the stress response, group
rearing is not very comparable maternal care. Another species of cichlid,
\textit{Astatotilapia burtoni}, however, display maternal care behaviors and may be able to better parallel
mammalian models.
...
\subsection{\textit{Astatotilapia burtoni} as a Model Organism}
 ...
 highly social cichlid species found in Lake Tanganyika. Females take part in an offspring care strategy known as mouthbrooding. The female lays eggs and immediately picks them up, storing them in
her buccal cavity. Shortly after this, the male fertilizes the eggs. The
mother keeps the offspring in her mouth for about two weeks as the eggs
develop into fry. Brooding
mothers voluntarily starve themselves on order to mouthbrood; however, in stressful situations they
will cannibalize their offspring. After the initial release, fry remain close to their mother
and return to their mother's mouth in the presence of danger \citep{renn_maternal_2009}.  Mouthbrooding helps to protect the developing fry from
...
The species has been used as a model organism in neuroendocrinology research due
...
cortisol and experience faster growth \citep{francis_social_1993,
  renn_fish_2008, fox_stress_1997}. Males are
able to switch between these phenotypes throughout their lives in response to
...
behavior, \textit{A. burtoni} may be a good model organism for studying the effects of
...
separation affects mouthbrooding fish and to what extent
...
maternal separation in teleost mimic those of mammals, they may be a good model
in which to continue examining the underlying mechanisms behind the adverse
outcomes associated with early-life stress.
...
I expected that changes in the stress response of fry separated from their mothers would be similar to the changes in stress response of rat pups exposed to low maternal care and \textit{N. pulcher} fry reared without adults. Therefore, I hypothesized that fish separated from their mothers would exhibit more anxiety
...
jaw. The eggs were then placed in a 250 mL flask within a new tank containing
...
placed into experimental conditions and consisted of two assays: boldness and
social. Both assays were performed on the same day (Figure \ref{time}).
...
maternal separation affects social behavior. Aggression is known to be
...
was counted by hand (Table \ref{ethogram}). The total sum of aggressive behaviors was then divided by
...
(Thermo Fisher 18080093) (Figure \ref{dogma}).
...
\hline
Target & Forward Primer (5' to 3')& Reverse Primer (5' to 3') & Annealing Temperature & Efficiency\\
\hline
...
\begin{figure}[h] 
\begin{center} 
\includegraphics[scale = 0.80]{size_by_broodsize}
...
significantly greater percentage of their time in the bottom of the tank
...
unseparated $\overline{x}$=1.12, \textit{t}(14)=0.26, \textit{p}=0.81) (Figure \ref{exp}).
...
(\textit{r}=0.30,\textit{p}<0.05) receptor expression (Figure \ref{cor1} and
\ref{cor2} respectively). Additionally, GR2 expression was negatively correlated
with length of fry (\textit{r}=0.31, \textit{p}<0.05) (Figure \ref{gr_length}).

\begin{figure}[h] 
\begin{center} 
\includegraphics[scale = 0.80]{lengthGR2}
\caption[Negative correlation between fry standard length and GR2
expression]{\footnotesize{Negative correlation between fry standard length and GR2
    expression.\\ The standard length of the fry was negatively correlated with GR2 expression (N=16), \textit{p}<0.05.}}
\label{gr_length}
\end{center} 
\end{figure}
...
In humans, early-life stress is known to
be tightly connected to adverse health outcomes including addiction, depression,
anxiety, PTSD, obesity, oxidative stress, mortality, and more
\citep{gilbert_burden_2009, repetti_risky_2002, anda_enduring_2006,
  heim_role_2001, essex_maternal_2002}.
Understanding the mechanism by which early-life experience translates to changes in
neurophysiology is crucial to developing treatments to help survivors of
traumatic childhood experiences. The use of animal models for human conditions offers an efficient and
tightly controlled way in which to examine behavior and physiology.

Differences in maternal care are a common way to model early-life
stress in animals \citep{bolton_new_2017}. 
In rats, high levels of licking and grooming lead to an increase in learning and
memory, a decrease in anxiety-like behavior, and an increase
in hippocampal GR expression \citep{herman_limbic_2005, caldji_maternal_1998}. This increase in GR
expression is thought to increase inhibitory feedback onto the HPA axis, thus
decreasing the pups' responsiveness to stressful stimuli
\citep{van_bodegom_modulation_2017}. The inverse of these observations is true
of pups reared by low maternal care mothers, with
pups displaying a heightened responsiveness to their stressful
environment \citep{liu_maternal_2000, caldji_maternal_1998}. Although these pups have decreased learning and memory in
non-stressful conditions, they also have an increase in learning and memory in
stressful conditions compared to their high maternal care counterparts
\citep{champagne_maternal_2008}. This suggests that the stress response adapts
to better fit the environment. In support of this concept, is the finding that
rat mothers in stressful environments have lower maternal care and thus produce
pups with heightened responsiveness \citep{francis_nongenomic_1999, champagne_stress_2006}. The rat model of maternal care is an example of how
early life stress can alter the adult animal's responsiveness to stress.

I was interested in analyzing whether this model of early-life stress can be
paralleled in fish. While most biomedical research
relies on the use of mammalian models, fish models are growing in popularity due to
the fact that fish share a large amount of gene
functionality with humans and are much more cost-effective
\citep{cech_cellular_2011}. 
\textit{A. burtoni} are a logical candidate for modeling the effects that
differences in maternal care have on the stress response because of their phenotypic plasticity, similar stress
response circuitry, and maternal
mouthbrooding behavior \citep{greenwood_multiple_2003, pijanowski_activity_2015,
  renn_fish_2008}.

While the impact of maternal
care on offspring stress response isn't well studied in fish, it has been shown that early life
social experience can influence the cichlid stress response
\citep{nyman_effect_2017, arnold_social_2010}. \textit {N. pulcher} fry raised in the
absence of adults have decreased telencephalic GR1a expression and higher
aggression. In contrast, fish reared in the naturalistic
social groups with adults and helper fish have reduced aggression and
increased telencephalic GR1a expression 
\citep{nyman_evolutionary_2018, bannier_early_2017}. This
work in \textit{N. pulcher} demonstrates that cichlids are plastic to their
early-life environments, and thus may be a good model of early-life stress.

In light of these results showing early-life plasticity in cichlids, I attempted
to model early-life stress in \textit{A. burtoni} through maternal separation
and measured by the offspring stress response through two behavioral paradigms and
a GR
expression assay. Fry
separated from their mothers spent a significantly greater amount of time in the
bottom of the novel tank; although, the amount of time spent in the top of the
tank and behind the shelter did not differ between experimental conditions.
While the two conditions did not differ in size, fish from broods of
one fry had a significantly greater body ration and length compared to fish from
broods of two or three fry. 
There was no significant difference in aggression or GR expression
levels between the conditions. Notably, there was a positive correlation between
GR2 expression and GR1a expression, as well as a positive correlation between
GR2 expression and GR1b expression. There was also a negative correlation
between GR2 expression and fry length. 

The finding that fish separated from their mothers spent more time in the bottom of the novel
...
indicative of anxiety-like behavior because teleosts, including \textit{A.
  burtoni}, in conditions known to produce a stress response prefer dark spaces, spend more time at the bottom of the tank, and avoid
open areas, often clinging to walls \citep{Gould2011, neumeister_socially_2017,
  ansai_chronic_2016, norton_three-spined_2019, ghisleni_role_2012}. For the opposite reason, spending time in the top of the
tank is indicative of reduced stress. The bottom region, however, is open to the
overhead lights; is more open than the shelter, but less open than the top; and also provides gravel as
camouflage. Because there is a trend toward separated fry spending more time in the top
...
boldness. This finding that separated fry had more boldness is counter to the hypothesis that
...
There was no significant difference in aggression between treatment groups. This is unlike the
finding by Taborsky that \textit{N. pulcher} raised without adults have higher levels of
aggression compared to those raised with adults \citep{arnold_social_2010}. One
confound in measuring aggression within broods
was that the most aggressive fry killed all of their siblings and thus couldn't
be included in the analysis.

Approximately half of the video recordings for the behavioral assays
were lost, making additional analysis impossible. In
...
reduced stress \citep{bannier_early_2017}. For this reason, it would have been useful to
have a count of entries into each of the regions for the boldness assay as well
as a measure of total distance travelled. In the aggression assay, it would be helpful to have assigned
...
In addition to receptor expression, circulating hormones can be used
...
Although there was no difference in GR expression between conditions, there were positive
...
and consistent GR expression profiles. This finding not only provides internal
validity for the gene expression measurements through the consistency, but also
suggests that there is some factor driving differences in GR expression. In the present study, not all variables that can influence GR expression were
...
larger change in HPA axis function in response to early life stress compared to males \citep{mccormick_sex-specific_1995}. 

In light of the correlation between standard length and GR2 expression in the
focal fry, it is possible that social conditions were much more influential on GR
expression than maternal separation was. While fry length is not a direct measure of dominance,
relative size of a male in a social group is a primary predictor of social rank
\citep{hofmann_social_1999}. Given that \textit{A. burtoni} are highly social
fish in which social status determines reproductive fitness and access to food, behavioral
plasticity in response to hierarchical ranking is adaptive
\citep{fox_stress_1997}. In adults, dominant males have an
increase in GR1a and GR2 expression in the preoptic area compared to
non-dominant males \citep{korzan_social_2014}. While the study was interested
in this brain region due to its involvement in sexual behavior, the preoptic
area also has an inhibitory effect on the HPA-axis by reducing ACTH release \citep{herman_role_2004}.

These results seem to contradict the current
finding that fry length is negatively correlated
with GR2 expression; however, this contrast is consistent with the literature
when considering the differences in methods. A recent study found that \textit{A. burtoni} fry raised in pairs had decreased whole-brain GR1a
expression compared to fry raised in groups
\citep{solomon-lane_early-life_2018}. While inhibitory regions of the brain,
like the hippocampus and preoptic area,
have increased GR expression throughout the brain in response to early-life stress, the net level GR
expression may actually decrease in response to stress. GRs have a wide range of
transcriptional effects besides those related to HPA axis regulation
\citep{2017Nrid}. If early-life stress decreases HPA axis inhibition through
decreased regulatory GR expression, it follows that an increase in the GR
expression of receptors that actually aid in reallocating energy towards an
inflammatory response or escape behavior would increase. This is supported by
the finding that there is an
increase in circulating cortisol, a major ligand for GRs, in animals exposed to
early-life stress \citep{essex_maternal_2002, zhang_epigenetics_2010}. 

A future study interested in using \textit{A. burtoni} to model early-life stress
could examine specific
regulatory regions of the brain. Complicating this possibility is the fact that the telencephalic pallium and medial
pallium of
\textit{A. burtoni} --- regions expected be responsive to early life stress --- are much smaller than the homologous structures in rats
...
stress offers a high throughput way to examine a complex condition. The present
study found that maternal separation did not impact the overall stress response
of fry, though different methods should be used to confirm these findings. To
better mirror studies done in mammals, a maternal care assessment could be
developed in place of maternal separation. The finding that size is correlated with GR2
expression supports evidence that early-life social experience contributes to
the adult stress response; however, further research is needed to understand the
brain-specific changes in GR expression. In sum, \textit{A. burtoni} have distinct GR expression profiles that appear to be mediated by their early-life environment, though not through maternal separation. Given the large influence that early-life stress exposure has on the developing
brain and body, it is important to continue research that uncovers reprogramming of the HPA axis.

%Antagonizing GRs in fry reared without adults and helpers resulted in more appropriate
%levels of aggression, indicating that the social effects of different rearing
%environments are mediated in part by GR \citep{nyman_evolutionary_2018}.
