...
Dysfunctional HPA-axis activity is associated with the development of
neuropsychological disease. The offspring of pregnant mice treated with synthetic glucocorticoids
 have delayed maturation of neurons and glia as well as delayed vascularization
 of the brain (olabi). Further, prenatal stress exposure is associated with
 decreased dendritic spine density in the cingulate gyrus and orbitofrontal
 cortex (Murmu, 2006).

 Behaviorally, prenatal stress is associated with cognitive impairments. Rats
 exposed to prenatal stress have impaired spatial and avoidance memory, and a corresponding
 decrease in CAMKII and CREB mRNA expression in the hippocampus (Sun; Sofiabadi,
 2018, Vallee, 2019).

 Prenatal stress increases nicotine CPP and DRD2 gene expression in nucc (Said, 2015)
 Prenatal stress increases benzodiazepine CPP (Lakehayli, 2015)
 Same as above but with cocaine (Pastor 2018)
 Also morphine because why not (Vey, 2016)
