...
reaction of internal responses, changing how an organism exists in its environment. From something as small as swatting at a fly to something as large as improvising jazz, our experiences as humans are a result of behaving. Put simply, this thesis will examine how maternal care (a stimulus) affects stress response (a behavior) in a mouth-brooding fish.

\section{Nature vs Nurture: Another Binary that Doesn't Exist}

In understanding why an animal responds to a stimulus in the way it does, there
are two places to start. One can look to the organisms' genotype \textit{i.e.},
was this behavior inherited genetically from its parents? Or one can look to the
organisms' upbringing \textit{i.e.}, did it learn this behavior over the course
of its life? Traditionally, these two possibilities have been thought of as
seperate and exclusive.  

The dichotomy of \textit{nature vs nurture} has its unfortunate beginnings in
the field of eugenics. The phrase was coined by the father of eugenics, Francis
...
his birth.'' (English Men of Science) In other words, nature is the genotype
that someone is born with and nurture is the environmental influences that shape
that individual's phenotype. What Galton was unable, or perhaps unwilling, to
discover was that gene expression and environment are tightly intertwined and do
...
\chapter{Epigenetics}
This thesis is focused on how the environment can influence gene expression.
