...
\textbf{Critical periods, prenatal, and why it makes sense evolutionarily.}
...
ACTH to a greater extent after being pre-treated with corticosterone. HLG pups
also developed higherer GR expression in the hippocampus as adults. In a
...
Unlike mammalian models, \textit{A. burtoni} and \textit{N. pulcher} are not
strictly relient on maternal care. \textit{N. pulcher} are highly social fish
...
predators and conspecifics (Arnold 2010). \textit{A. burtoni}, the focus of this
...
Taborsky found that \textit{N. pulcher} fry raised in the
absense of adults were more aggressive in social situations and had decreased whole-brain GR1
expression and CRH than those raised with parents and helpers. These findings
are inconsistent with Meaney's. (Aronold 2010 and Taborsky 2012). In the
telencephalon, there was an increase in GR1 mRNA expression (Nyman, Taborsky
2018).
