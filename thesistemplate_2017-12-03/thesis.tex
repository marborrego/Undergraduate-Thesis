...
norepinephrinergic neurons in the hind brain. These neurons can in turn stimulate neurons in
the hypothalamus. It is also possible to activate the HPA axis as an
anticipatory response. If an organism has been conditioned to associate a given
stimulus with an unconditioned threat, in the presence of the conditioned
stimulus alone, it can trigger the HPA axis. This requires polysynaptic signaling from limbic
