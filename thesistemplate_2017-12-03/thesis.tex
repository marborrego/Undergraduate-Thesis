...
organism's upbringing \textit{i.e.}, was this behavior acquired in response to
the enviornment, over the course
of its life? Traditionally, these two possibilities have been thought of as
seperate and exclusive, as in the phrase \textit{nature} vs \textit{nurture}.  
...
his birth.'' (English Men of Science) While there was not yet a concept of DNA,
the Darwin's theory of evolution and Mendel's inheritence experiments were in circulation.

The interest in nature \textit{vs} nurture remained within developmental
psychology until late in the 20th century when behavioral and developmental
neurosciences were popularized.
However, the fields of animal behavior and
molecular biology were being revolutionized in ways that would ultimately contribute to the modern debate of
nature and nurture (Modern nature nurture review).

In the 1930's a pioneering behavioral scientist by the name of Nikolaas Tinbergen began
...
ontogeny and evolution (Four Questions).

These four categories can be understood as a matrix with the axes \textit{how? and
  why?} and \textit{proximate and ultimate}. Causation is a proximate question
of how physiological mechanisms contribute to a behavior. Ontogeny is the
proximate why an individual organism has behaved in a specific way. Survival
value is the ultimate question why this behavior is exists. Lastly, evolution is the
proximate question of how a behavior arose in a population. Tinbergen's four
questions were important in examining a single behavior as a product of an
...
From something as small as swatting at a fly to something as large as improvising jazz, our experiences as humans are a result of behaving. Put simply, this thesis will examine how maternal care (a stimulus) affects stress response (a behavior) in a mouth-brooding fish.
...
homeostatis (Bodegom). We often times think about stress as a negative state to
be in;
however, stress can help us to fight of infections, play well in a
soccer game, or chase down the bus that was missed. 

\section{The Hypothalamic-Pituitary-Adrenal Axis}
 The
stress response is made possible by the hypothalamic-pituitary-adrenal (HPA) axis. Activation of the axis by a stressor leads to a cascade of central and
peripheral responses that help in returning the body to homeostasis.
...
Corticosteroids are a class of hormones that can bind to glucorticoid receptors (GRs)
and mineralocorticoid receptors (MRs).

\section{Negative Effects of Stress}
	
\chapter{Long Term Effects of Early Life Experience}
...
were manually removed from their mouths by gently pulling down their bottom
