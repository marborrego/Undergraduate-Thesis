...
% If your abstract is longer than a page, there may be a formatting issue.
  ...
  ring}{Chika Sigawa \\ \textit{Mountain Range}}
For Langston.
...
his birth.'' (Galton, 1874) While there was not yet a concept of DNA,
...
%proximate question of how a behavior arose in a population.
...
more deeply explored in Chapter 1), is
...
Because gene expression is so often altered by the environment, our notion of
...
enviornmental influences or how the environment influences the quantity of a
protein produced. 
...
As described in the introduction, epigenetics refers to the ways in which DNA is
made more or less accessible for transcription. Two common ways that genes are
either transcribed more or less are through histone
modification and DNA methylation respectively. Histones are proteins that DNA
wraps around when in a compact state.  
